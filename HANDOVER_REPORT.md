...
- **Severidad:** 🟡 Media 
- **Problema:** El ci.yml no esta siendo aplicado en Github actions
- **Solución:** Configurar el workflow en Github Actions para automatizar el proceso full AI-Native.
- 
#### Base de Datos
